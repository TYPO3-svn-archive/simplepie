<?php
/**
 * f:for with iteration and isFirst/isLast
 * http://forge.typo3.org/issues/6149
 * http://forge.typo3.org/attachments/3393/patch_6149.diff
 */
 ...
 * @scope prototype
 */
class Tx_Simplepie_ViewHelpers_ForViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 * @param string $iteration The name of the variable to store iteration data like isFirst, isLast ...
	 ...
	 * @api
	 */
	public function render($each, $as, $key = '', $iteration = '', $reverse = FALSE) {
		$output = '';
		if ($each === NULL) {
			return '';
		}
		...
		$iterationData['cycle'] = 1;
		$iterationData['total'] = count($each);
